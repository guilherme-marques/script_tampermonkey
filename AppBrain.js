...
// @author       You
// @match        http://www.appbrain.com/search*
...
//PODE TESTAR COM ISSO: http://www.appbrain.com/search?q=futebol&src=header
console.log("comecou");
...
setInterval(function(){
                if($(selection).length > 0 && started === false){
                    started = true;
                    (function() {
